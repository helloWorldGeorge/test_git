...
<body>
	<s:form action="addVoZHANGTAO.action" method="post">
		<!-- add_jsp -->
<s:textarea cols="130" rows="2" name="name" label="项目名称" />
<s:textarea cols="130" rows="2" name="serverInfo" label="服务器信息" />
<s:textarea cols="130" rows="2" name="backSpaceInfo" label="后台信息" />
<s:textarea cols="130" rows="2" name="thirdPartyInfo" label="第三方账户信息" />
