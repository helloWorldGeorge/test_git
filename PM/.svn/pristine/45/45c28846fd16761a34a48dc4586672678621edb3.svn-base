...
<body>
<s:form action="editVoProTask.action" method="post">
...
<tr><td>提交日期<td></td><td><span class="OLD_TXT"><s:date name="#request.voProTask.subDate" format="yyyy-MM-dd" /></span></td><td><s:textfield name="subDate" label="提交日期" id="popupDatepicker" readonly="true"><s:param name="value" ><s:date name="%{#request.voProTask.subDate}" format="yyyy-MM-dd" /></s:param></s:textfield></td></tr>
<tr><td>计划开始日期<td></td><td><span class="OLD_TXT"><s:date name="#request.voProTask.planStartDate" format="yyyy-MM-dd" /></span></td><td><s:textfield name="planStartDate" label="计划开始日期" id="popupDatepicker" readonly="true"><s:param name="value" ><s:date name="%{#request.voProTask.planStartDate}" format="yyyy-MM-dd" /></s:param></s:textfield></td></tr>
<tr><td>实际开始日期<td></td><td><span class="OLD_TXT"><s:date name="#request.voProTask.actualStartDate" format="yyyy-MM-dd" /></span></td><td><s:textfield name="actualStartDate" label="实际开始日期" id="popupDatepicker" readonly="true"><s:param name="value" ><s:date name="%{#request.voProTask.actualStartDate}" format="yyyy-MM-dd" /></s:param></s:textfield></td></tr>
<tr><td>计划结束日期<td></td><td><span class="OLD_TXT"><s:date name="#request.voProTask.planEndDate" format="yyyy-MM-dd" /></span></td><td><s:textfield name="planEndDate" label="计划结束日期" id="popupDatepicker" readonly="true"><s:param name="value" ><s:date name="%{#request.voProTask.planEndDate}" format="yyyy-MM-dd" /></s:param></s:textfield></td></tr>
<tr><td>实际结束日期<td></td><td><span class="OLD_TXT"><s:date name="#request.voProTask.actualEndDate" format="yyyy-MM-dd" /></span></td><td><s:textfield name="actualEndDate" label="实际结束日期" id="popupDatepicker" readonly="true"><s:param name="value" ><s:date name="%{#request.voProTask.actualEndDate}" format="yyyy-MM-dd" /></s:param></s:textfield></td></tr>
